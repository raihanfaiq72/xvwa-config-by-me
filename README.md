XVWA CONFIG BY ME
=========================================
tanpa mengurangi rasa hormat saya terhadap developer xvwa , tujuan saya membuat ini agar supaya memudahkan saya dalam menggunakan xvwa ini. jadi xvwa ini beberapa saya sesuaikan dengan lingkungan saya. terimakasih atas pengertiannya
=========================================
```
// clone repo ini
$ git clone https://github.com/raihanfaiq72/xvwa-config-by-me.git

// kemudian buat dan import db yang sudah disiapkan
$ mysql -u username -p -e "create database xvwa" && mysql -u root -p xvwa < db.sql

// jalankan xvwa
$ php -S localhost:777

// ready to go!
$ localhost:777 -> sudah tidak perlu setup soalnya sudah terimport db nya
```
